...
* Setup the blog to build on the root. From the _Files_ tTab on rstudio.cloud, click on the file _site.yml to open it; then replace `output_dir: "_site"` with `output_dir: "."`.
