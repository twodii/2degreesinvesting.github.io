...
* How to [Connect RStudio to Git and GitHub](https://happygitwithr.com/rstudio-git-github.html) (book chapter). If you are already set, use this guide to confirm we are all set in the same way.
...
Git is the heart of GitHub. We use it to track each meaningful change in our projects. You may use Git from the terminal or from a dedicated program (e.g. [GitKraken](https://www.gitkraken.com/)); but you rarely need anything special because the most useful features of Git are available directly from RStudio. This resource explains why we use Git and how it relates to Github and RStudio:
