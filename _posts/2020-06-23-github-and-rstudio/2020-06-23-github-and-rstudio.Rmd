...
We are working on multiple projects you may want to know [about](https://2degreesinvesting.github.io/about.html). If you have questions about anything in this post, come to the [coding-helpdesk](xxxxxxxxx); we'll be glad to help you.

Before you go, please help us improve this post; that will help your future colleagues. What is one thing you particularly liked, and one thing we could improve?


# TODO

* maybe link 2DegreesInvesting/resources as well? (edited)  -- JACKSON

* maybe something about GitHub organizations, since that’s something that not everyone is familiar with / has worked with in a previous org?

* and something about getting/requesting access to our repositories since some (none?) of our repos are open to everyone in the 2dii GitHub org? -- CJ

* Advertise the ds-incubator
* Advertise the #coding channel
* Invite people to write blog posts